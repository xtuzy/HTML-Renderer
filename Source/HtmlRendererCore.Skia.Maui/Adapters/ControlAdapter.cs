...
namespace HtmlRendererCore.Skia.Maui.Adapters
{
    /// <summary>
    ...
    internal sealed class ControlAdapter : RControl
    {
        ...
        {
            using (var g = new SKGraphicsAdapter())
            {
        ...
        {
            (_control as SKCanvasView).InvalidateSurface();
        }
    }
}